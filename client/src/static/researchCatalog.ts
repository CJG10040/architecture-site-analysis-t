...
export const researchCatalog: ResearchCatalogItem[] = [
  ...
  { id: "public-welfare", category: "사람·주거·생활", title: "복지·교육·의료·공공시설", source: "VWorld 복지시설 · 공공데이터포털 시설 표준데이터 · 지자체 시설 API", role: "생활권의 돌봄·교육·의료·공공서비스 접근 맥락을 파악", unit: "시설 POI", status: "partial", priority: "P1", lenses: ["사람·주거·생활", "지역 생활"], limitation: "시설 존재가 이용 가능성·수요 충족을 의미하지 않으며 운영시간과 현장 접근성을 별도 확인합니다.", officialUrl: "https://www.data.go.kr/" },
  { id: "culture-heritage", category: "문화·기억·유휴", title: "문화시설·국가유산·지역 기억", source: "VWorld 박물관·도서관 · 한국문화정보원 · 국가유산청", role: "보존·기억·재사용·지역 정체성의 공간적 단서를 탐색", unit: "시설·유산 POI/경계", status: "partial", priority: "P2", lenses: ["문화·기억·유휴"], limitation: "공식 등록자료가 지역의 모든 기억과 사용 흔적을 대표하지 않으므로 주민·현장 자료가 필요합니다.", officialUrl: "https://www.data.go.kr/data/15125097/openapi.do" },
  { id: "hydrology", category: "생태·기후·물", title: "하천·수계·침수·배수", source: "OpenStreetMap 수로 표본 · VWorld 수자원 레이어 · 국가/지자체 재해정보", role: "물의 흐름·저지대·수변 관계와 기후 위험을 확인", unit: "선·면·위험구역", status: "partial", priority: "P1", lenses: ["생태·기후·물", "지형·레벨"], limitation: "현재 OSM 수로·수면 공간 표본을 자동 연결합니다. 침수·배수 판단은 공식 위험지도와 현장 레벨·배수시설 확인을 함께 요구합니다.", officialUrl: "https://www.data.go.kr/data/15058825/openapi.do" },
