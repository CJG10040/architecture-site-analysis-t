...
const allowed = ["naverMapsClientId", "vworldKey", "vworldDomain", "dataGoKrKey", "sgisClientId", "sgisClientSecret", "openaiApiKey", "geminiApiKey", "anthropicApiKey"] as const;
...
export function emptyKeyFileTemplate() {
  return JSON.stringify({ schema: "site-analysis-keys-v1", naverMapsClientId: "", vworldKey: "", vworldDomain: "", dataGoKrKey: "", sgisClientId: "", sgisClientSecret: "", openaiApiKey: "", geminiApiKey: "", anthropicApiKey: "" }, null, 2);
}
