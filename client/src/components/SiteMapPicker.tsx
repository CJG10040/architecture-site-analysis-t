...
import type { BoundaryPoint } from "@/static/model";
...
export function SiteMapPicker({ apiKey, latitude, longitude, address, boundary, onSiteChange, onBoundaryChange, onOpenSettings }: Props) {
