...
export function SiteMapPicker({ clientId, latitude, longitude, address, boundary, radiusMeters, overlays, onSiteChange, onBoundaryChange, onOpenSettings }: Props) {
